...
function FormGroupSearchRowRecruitment(props) {
      ...
      {props.componentRight ? (
        <div style={props.styleAction} className={`${styles["group-action"]}`}>
          ...
          {isShowFilterColumnTable ? (
            <div onClick={handleTriggerPopup} className={styles["icon-action"]}>
...
FormGroupSearchRowRecruitment.propTypes = {
...
export default FormGroupSearchRowRecruitment;
