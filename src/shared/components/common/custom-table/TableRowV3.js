  ...
  return (
    <div
      ...
      className={`${styles["TableRow"]} ${
        isParent && !row?.ParentId ? styles["isParent"] : ""
      }`}
      ...
      <div className={`${styles["MainRow"]}`} style={{ height: rowHeight }}>
        ...
        {isShowCheckBoxColumn && (
          ...
          >
            <Checkbox
              // disabled={
              //   row?.Status === Constants.TEXT_STATUS.STATUS_APPROVE.VALUE ||
              //   row?.Status === Constants.TEXT_STATUS.STATUS_NOT_APPROVE.VALUE
              // }
              onClick={(event) => {
